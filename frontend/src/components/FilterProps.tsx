// FilterProps are used by components which handle everything internally for
// user selection of supported filter parameters, then on-change, use the below
// callback. Any "client" of such a callback will receive 'data' in the form of
// a key-value pair object which can be passed directly in ".where" for the
// chain of methods involved in a Spraypaint data read call.
//
